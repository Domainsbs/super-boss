    ...
    <section className="py-6 mx-auto max-w-7xl px-3 bg-white">
      ...
      <div className="mb-4 md:mb-6">
        <div className="text-center mb-3 md:mb-4">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">Shop By Categories</h2>
          <div className="flex items-center justify-center mt-2 md:mt-3 mb-2">
            <div className="h-1 w-16 md:w-20 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full"></div>
          </div>
        </div>
        <div className="flex justify-end">
          <button
            onClick={() => onCategoryClick && onCategoryClick("all")}
            className="text-gray-700 hover:text-primary-600 font-medium text-xs md:text-sm border border-gray-300 px-3 md:px-4 py-1.5 md:py-2 rounded-lg hover:border-primary-600 transition-colors whitespace-nowrap"
          >
            VIEW ALL
          </button>
        </div>
      ...
      <div className="relative">
        ...
        <div
          ...
          className="flex gap-2 md:gap-4 overflow-x-auto scrollbar-hide scroll-smooth px-2 py-4"
        ...
        >
          {categories.map((category) => (
            <Link
              ...
              style={{ width: "calc(14.28% - 14px)", minWidth: "120px" }}
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                ...
                <div className="p-2 md:p-3 text-center bg-white">
                  <h3 className="text-xs md:text-sm font-semibold text-gray-900 group-hover:text-primary-600 transition-colors line-clamp-2">
                    {category.name}
                  </h3>
                </div>
              </div>
