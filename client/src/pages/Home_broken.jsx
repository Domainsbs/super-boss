...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50">
            ...
            {notifStep === "ask" && (
              <>
                ...
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <button className="px-4 py-2 rounded bg-primary-600 text-white font-semibold" onClick={handleNotifAllow}>
                    Allow
                  </button>
                </div>
              </>
            ...
            {notifStep === "email" && !notifSuccess && (
              <form onSubmit={handleNotifEmailSubmit}>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded bg-primary-600 text-white font-semibold disabled:opacity-50"
                    disabled={notifLoading}
                  >
                    {notifLoading ? "..." : "Subscribe"}
                  </button>
                </div>
                {notifError && <p className="text-red-500 text-sm mb-2">{notifError}</p>}
                <button
                  type="button"
            ...
            {notifSuccess && (
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  You will receive the latest updates and offers directly to your inbox.
                </p>
                <button
                  className="px-4 py-2 rounded bg-primary-600 text-white font-semibold"
                  onClick={() => setShowNotifPopup(false)}
                >
                  Close
                </button>
      ...
      {/* 2. SALE PRODUCTS (FEATURED) - Simple Slider without BG */}
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Featured Products</h2>
              <p className="text-gray-600 mt-1">Special deals and best sellers</p>
            </div>
      ...
      {/* 3. PRODUCT SECTION - 6 Products (All Screens) */}
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Trending Now</h2>
              <p className="text-gray-600 mt-1">Most popular products this month</p>
            </div>
            <Link to="/shop" className="text-primary-600 hover:text-primary-700 font-semibold flex items-center gap-2">
              View All <ChevronRight size={20} />
            </Link>
      ...
      {/* 4. ALL CATEGORIES - Scrolling Slider with Images */}
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Shop by Category</h2>
              <p className="text-gray-600 mt-1">Browse our wide range of products</p>
            </div>
          </div>
          <CategorySlider />
        </div>
      ...
      {/* 5. PRODUCT SECTION - 6 Products Fixed */}
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
          ...
          <ProductGrid products={featuredProducts.slice(6, 12)} />
        </div>
      </section>

      {/* 6. BRAND SECTION - Scrolling Slider */}
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Shop by Brand</h2>
              <p className="text-gray-600 mt-1">Discover products from top brands</p>
            </div>
            <Link to="/brands" className="text-primary-600 hover:text-primary-700 font-semibold flex items-center gap-2">
              View All Brands <ChevronRight size={20} />
            </Link>
          </div>
          <BrandSlider />
        </div>
      ...
      {/* 7. PRODUCT SECTION - 6 Products #1 */}
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
            ...
            <Link to="/shop?sort=newest" className="text-primary-600 hover:text-primary-700 font-semibold flex items-center gap-2">
              View All <ChevronRight size={20} />
            </Link>
          </div>
          <ProductGrid products={featuredProducts.slice(12, 18)} />
        </div>
      </section>

      {/* 8. PRODUCT SECTION - 6 Products #2 */}
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Special Offers</h2>
              <p className="text-gray-600 mt-1">Don't miss these amazing deals</p>
            </div>
            <Link to="/shop?filter=discount" className="text-primary-600 hover:text-primary-700 font-semibold flex items-center gap-2">
              View All <ChevronRight size={20} />
            </Link>
          </div>
          <ProductGrid products={featuredProducts.slice(18, 24)} />
        </div>
      </section>

      {/* 9. FOOTER - Will be rendered by Layout */}
    </div>
  )
}
