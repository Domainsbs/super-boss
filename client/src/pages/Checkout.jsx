  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-5xl mx-auto px-4 py-10 text-center">
        <h2 className="text-2xl font-bold mb-4">Your cart is empty</h2>
        <p className="text-gray-600 mb-6">Add some items to your cart before checkout.</p>
        <button onClick={() => navigate("/")} className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg px-8 py-3">
          Continue Shopping
        </button>
      </div>
    )
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5">
          <div className="lg:col-span-3 p-2 ">
            ...
            <div className="flex flex-row items-center gap-2 sm:gap-4 md:gap-8 w-full overflow-x-auto mb-8">
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 1 ? "bg-gradient-to-r from-purple-600 to-blue-600" : "bg-gray-300"}`}
                >
                  01
                </span>
                <span className="font-semibold text-xs sm:text-sm md:text-base">Shipping Details</span>
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 2 ? "bg-gradient-to-r from-purple-600 to-blue-600" : "bg-gray-300"}`}
                >
                  02
                </span>
                <span
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 3 ? "bg-gradient-to-r from-purple-600 to-blue-600" : "bg-gray-300"}`}
                >
                  03
                </span>
                <span
                ...
                <>
                    ...
                    <form onSubmit={handleContinueToSummary}>
                      ...
                      <div className="mt-8 flex gap-4 ">
                        <button
                          type="button"
                          onClick={() => navigate("/cart")}
                          className="flex-1 border border-gray-300 hover:bg-gray-100 text-gray-700 font-semibold lg:py-3 lg:px-6 py-2 px-3 rounded-lg transition duration-300"
                        >
                          Back to Cart
                        </button>
                        <button
                          type="submit"
                          className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold lg:py-3 lg:px-6 py-2 px-3 rounded-lg transition duration-300"
                        >
                          <span className="block lg:hidden">Continue Summary</span> {/* Mobile */}
                          <span className="hidden lg:block">Continue to Summary</span> {/* Desktop */}
                        </button>
                  ...
                  {deliveryType === "pickup" && (
                    <form onSubmit={handleContinueToSummary}>
                      ...
                      <button
                        type="submit"
                        className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg px-8 py-3 disabled:opacity-50"
                        disabled={!pickupDetails.phone || !pickupDetails.storeId}
                      >
                        Continue
                      </button>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <textarea
                        value={customerNotes}
                        onChange={(e) => setCustomerNotes(e.target.value)}
                        className="w-full border rounded-lg px-4 py-3 resize-none focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        rows="3"
                        placeholder="Special delivery instructions, gift message, or any other notes..."
                        maxLength="500"
                      />
                ...
                <div>
                    ...
                    {PAYMENT_METHODS.map((method) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          checked={selectedPaymentMethod === method.id}
                          onChange={() => setSelectedPaymentMethod(method.id)}
                          className="absolute top-20 left-16 accent-purple-600 w-4 h-4"
                        />
                          ...
                          <div className="flex gap-2 flex-wrap justify-center">
                            {method.iconUrls.map((icon, idx) => (
                              <img
                                ...
                                alt={method.name}
                                className={`w-60 h-48 md:w-60 md:h-36 object-contain rounded-lg transition-all ${
                                  selectedPaymentMethod === method.id ? " border-purple-500" : " border-gray-200"
                                }`}
                              />
                            ))}
                          </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      disabled={loading || !selectedPaymentMethod}
                      className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg px-6 py-3 disabled:opacity-50 flex items-center gap-2"
                    >
                      {loading ? (
                        <>
          ...
          {/* Order Summary Sidebar */}
          <div className="lg:col-span-2 mt-4">
            <div className="rounded-lg shadow-md border border-purple-100 p-4 lg:mx-9 sticky top-4">
              <div className="flex items-center mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    {!coupon ? (
                      <button
                        className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-4 py-2 rounded-lg text-sm disabled:opacity-50"
                        onClick={handleApplyCoupon}
                        disabled={couponLoading || !couponInput}
                      >
                        {couponLoading ? "Applying..." : "Apply"}
                  ...
                  {couponError && <div className="text-red-500 text-xs">{couponError}</div>}
                  {coupon && (
                    <div className="flex justify-between text-sm bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent font-medium">
                      <span>Coupon: {coupon.code}</span>
                      <span>- {formatPrice(couponDiscount)}</span>
                    </div>
                  )}
              ...
              <form onSubmit={handleAddressModalSubmit}>
                ...
                <div className="flex gap-4">
                  <button
                    type="button"
                    onClick={() => setShowAddressModal(false)}
                    className="border border-gray-300 text-gray-700 rounded-lg px-8 py-3 hover:bg-gray-100"
                  >
                    Cancel
                  </button>
                  <button type="submit" className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg px-8 py-3">
                    Save Address
                  </button>
                </div>
              </form>
